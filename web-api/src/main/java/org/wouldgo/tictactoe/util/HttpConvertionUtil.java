package org.wouldgo.tictactoe.util;
...
public class HttpConvertionUtil {
	...
	/**
	 * <p>
	 * Utility method used to build up a {@linkplain ResponseEntity} from an
	 * exception.
	 * </p>
	 * <p>
	 * This checks if the exception caught is annotated with
	 * {@linkplain ResponseStatus} and if yes uses that http status code.
	 * </p>
	 * Then builds an {@linkplain ErrorMessage} with the exception message.
	 *
	 * @param exception
	 *            the exception caught.
	 * @return the {@linkplain ResponseEntity} used to return to client caller
	 *         the error.
	 */
