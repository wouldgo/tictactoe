...
import org.wouldgo.tictactoe.util.ErrorMessage;
import org.wouldgo.tictactoe.util.HttpConvertionUtil;

/**
 * {@linkplain ControllerAdvice} that manages all the exceptions raised by
 * controllers.
 *
 * @author "wouldgo"
 *
...
public class ExceptionControllerAdvice {
	 ...
	 *
	 * @param ex
	 *            the {@linkplain Exception} raised during execution
